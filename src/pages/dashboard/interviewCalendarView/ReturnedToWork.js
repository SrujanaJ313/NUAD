...
function ReturnedToWork({ onCancel, event, onSubmitClose, caseDetails }) {
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      <Stack spacing={2} sx={{ marginTop: "20px" }}>
        ...
        <Stack direction="row" spacing={2}>
          <Typography sx={{ width: "15%", color: isViewMode ? "gray" : "" }}>
            Staff notes, if any:
          </Typography>
          <TextField
            label="Staff Notes"
            ...
            <Stack direction="row" spacing={2} sx={{ width: "100%" }}>
              <Stack sx={{ width: "50%" }}>
                <FormControlLabel
                  ...
                  label="890: A non-direct placement recorded in JMS"
                />
              ...
              <Stack sx={{ width: "50%" }}>
                <FormControlLabel
                  ...
                  label="HIRE indicated in JMS referral"
                />
