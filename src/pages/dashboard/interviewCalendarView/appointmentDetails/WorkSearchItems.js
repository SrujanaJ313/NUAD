...
function WorkSearchItems({ data, formik, disableForm }) {
  ...
  const isDisabledWeek = (weekEndDt) => {
    return (
      values.workSearchIssues.find((x) => x.weekEndingDt === weekEndDt)
        ?.editable === false
    );
  };
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  sx={{ py: 0, pl: 0 }}
                  disabled={disableForm || isDisabledWeek(row.weekEndingDt)}
                />
              }
                ...
                <FormControlLabel
                  ...
                  control={
                    <Radio
                      ...
                      sx={{ py: 0 }}
                      disabled={
                        !isChecked(row.weekEndingDt) ||
                        disableForm ||
                        isDisabledWeek(row.weekEndingDt)
                      }
                    />
                  }
                  label="No Issues"
                ...
                <Stack direction="row" spacing={1} alignItems="flex-start">
                  ...
                  <FormControl sx={{ width: 150 }} size="small">
                    <Select
                      size="small"
                      disabled={
                        !checkSelectDisabled(row.weekEndingDt) ||
                        disableForm ||
                        isDisabledWeek(row.weekEndingDt)
                      }
